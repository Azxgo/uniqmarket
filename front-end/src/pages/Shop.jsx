...
export default function Shop() {
    ...
    return (
        <div className="container mx-auto">
            <button
                className="lg:hidden bg-zinc-400 text-white text-lg p-3 rounded-md w-full mb-4"
                onClick={() => setShowFilters(!showFilters)}
            >
                Filtros
            </button>
            <div className="grid grid-cols-1 lg:grid-cols-[290px_1fr] gap-6 w-full">
                <div
                    className={`
                ...
                >
                    <div className="flex flex-col items-center text-center rounded-md shadow-md p-5 bg-white">
                        ...
                        <div className="w-full border-b-1 border-gray-300 pb-3 mb-3">
                            <button
                                className="bg-zinc-400 text-white text-xl p-2 w-full rounded-md hover:opacity-70 cursor-pointer"
                        ...
                        <div className="flex flex-col w-full mt-4 gap-4">
                            <button className="bg-zinc-400 text-white text-xl p-2 w-full rounded-md  hover:opacity-70 cursor-pointer"
                ...
                <main className="flex flex-col rounded-md shadow-md p-2 bg-white w-full">
                    ...
                    ) : !isLoading && hasLoaded && paginatedProducts.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-64 text-gray-500">
                            <h2 className="text-2xl font-semibold">No se encontraron productos.</h2>
                        </div>
                    ) : (
                        <div className="flex flex-wrap gap-3 justify-center mt-2 py-2">
                                ...
                                <Link key={prod.product_id} to={`/product/${prod.product_id}`} className="cursor-pointer">
                                    <div className="flex flex-col w-full max-w-[250px] h-full max-h-[450px] border border-gray-300 shadow-md rounded-lg transition-transform duration-200 hover:-translate-y-1 hover:shadow-lg overflow-hidden">
                                        <img
                                            ...
                                            width="208"
                                            height="208"
                                            className="w-52 h-52 object-cover mx-auto bg-gray-100"
                                        />
