...
export default function AdminVendors() {
    ...
    const { vendors, setVendors, isLoading } = useVendors()
    ...
    const deleteVendor = async (id) => {
        const res = await fetch(`https://uniqmarket.onrender.com/api/admin/vendors/delete/${id}`, {
            method: "DELETE",
            credentials: "include"
        });
    ...
    const handleSave = async (_, newName) => {
        ...
        try {
            const res = await fetch("https://uniqmarket.onrender.com/api/admin/vendors/add", {
                method: "POST",
