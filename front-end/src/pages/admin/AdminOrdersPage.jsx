...
export default function AdminOrdersPage() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const res = await fetch(`https://uniqmarket.onrender.com/api/admin/orders/update/${id}`, {
                method: "PUT",
    ...
    useEffect(() => {
        const fetchOrder = async () => {
            const res = await fetch(`https://uniqmarket.onrender.com/api/admin/orders/get/${id}`, {
                credentials: "include"
            })
