...
export default function AdminCategories() {
  ...
  const handleSave = async (categoryId, newName, deletedId = null) => {
    ...
    if (categoryId) {
      const res = await fetch(`https://uniqmarket.onrender.com/api/admin/category/update/${categoryId}`, {
        method: "PUT",
      ...
      const res = await fetch(`https://uniqmarket.onrender.com/api/admin/category/add`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ name: newName }),
        credentials: "include"
