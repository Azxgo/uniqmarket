...
export default function AdminVendorsPage() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const res = await fetch(`https://uniqmarket.onrender.com/api/admin/vendors/update/${id}`, {
                method: "PUT",
    ...
    useEffect(() => {
        const fetchVendor = async () => {
            const res = await fetch(`https://uniqmarket.onrender.com/api/admin/vendors/get/${id}`, {
                credentials: "include"
            })
